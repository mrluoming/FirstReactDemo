    ...
    return (
      <header className={classnames}>
        <div className="navbar-branding">
            ...
            <img src={logoImg} alt="logo" /><b>React</b>Demo
        ...
        <ul className="nav navbar-nav navbar-right clearfix">
          <li>
            <a href="https://github.com/mrluoming/FirstReactDemo">
          ...
          <li className="dropdown">
            <Popover placement="bottomRight" title={`WELCOME test`} 
              overlayClassName={cx("navbar-popup", {[theme]: !!theme})} content={<UserDropDown />} trigger="click">
              <a className="dropdown-toggle">
                <Badge dot><Avatar src={require('assets/images/avatar.jpg')}>test</Avatar></Badge>
              </a>
            </Popover>
          </li>
        </ul>
